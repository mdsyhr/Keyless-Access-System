...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a class="active" href="user_data.php"><i class="fas fa-users"></i> User Data</a>
        <a href="vehicle_info.php"><i class="fas fa-car"></i> Vehicle Info</a>
    ...
    <div class="col-md-12 text-center">
        ...
        <?php
            ...
            $sql = 'SELECT * FROM table_nodemcu_rfidrc522_mysql WHERE email = ? ORDER BY name ASC';
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="card">
                        ...
                        <div class="edit-delete-buttons">
                            <a href="user_data_edit_page.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
                            <a href="user_data_delete_page.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete</a>
                        </div>
                    </div>
                    <?php
                }
    ...
    <div class="row card-container">
        <?php
            $sql_vehicle = 'SELECT * FROM vehicle_register WHERE email = ? ORDER BY id ASC';
            $stmt_vehicle = $mysqli->prepare($sql_vehicle);
            $stmt_vehicle->bind_param("s", $email);
            ...
            if ($result_vehicle->num_rows > 0) {
                while ($row_vehicle = $result_vehicle->fetch_assoc()) {
                    ...
                    <div class="card">
                        ...
                        <div class="edit-delete-buttons">
                            <a href="vehicle_info_edit.php?plate_number=<?php echo htmlspecialchars($row_vehicle['plate_number']); ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
                            <a href="vehicle_info_delete.php?IDs=<?php echo htmlspecialchars($row_vehicle['IDs']); ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete</a>
                        </div>
                    </div>
                    <?php
                }
